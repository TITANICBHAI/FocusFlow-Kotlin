...
GitHub Actions is the reliable APK build environment for this project because its workflow provisions Java 17 and the Android SDK; the local Replit shell may lack both Java and the Android SDK.
